...
const ownername = 'Iyan'
const myweb = 'https://wa.me/62895323413434'
...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
            ...
            break
            case 'sc': {
                m.reply('Sc? :https://nekopoi.care\n𝐄𝐇 Salah😅☝️\nhttps://github.com/IyanXd\n\nJangan Lupa Follow\nINSTAGRAM:https://www.instagram.com/iyan_jb')
            }
            break
            case 'chat': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                ...
                                callButton: {
                                    ...
                                    phoneNumber: 'wa.me/62895323413434'
                                }
                            }, {
                                quickReplyButton: {
...
⭔ Url : ${anu.url}`,
		...
		let { pinterest } = require('./lib/scraper')
            ...
            case 'anime': case 'waifu': case 'husbu': case 'neko': case 'shinobu': case 'megumin': {
                m.reply(mess.wait)
                hisoka.sendMessage(m.chat, { image: { url: api('lolhuman', '/api/random/anime/'+command, 'apikey') }, caption: `Download From ${text}` }, { quoted: m})
            }
            break
	    case 'couple': {
                m.reply(mess.wait)
		...
		let { quotesAnime } = require('./lib/scraper')
	        ...
	        case 'motivasi': case 'dilanquote': case 'bucinquote': case 'katasenja': case 'puisi': {
                let anu = await fetchJson(api('lolhuman', '/api/'+command, {}, 'apikey'))
                let buttons = [
            ...
            case '3dchristmas': case '3ddeepsea': case 'americanflag': case '3dscifi': case '3drainbow': case '3dwaterpipe': case 'halloweenskeleton': case 'sketch': case 'bluecircuit': case 'space': case 'metallic': case 'fiction': case 'greenhorror': case 'transformer': case 'berry': case 'thunder': case 'magma': case '3dcrackedstone': case '3dneonlight': case 'impressiveglitch': case 'naturalleaves': case 'fireworksparkle': case 'matrix': case 'dropwater':  case 'harrypotter': case 'foggywindow': case 'neondevils': case 'christmasholiday': case '3dgradient': case 'blackpink': case 'gluetext': {
                ...
                m.reply(mess.wait)
                hisoka.sendMessage(m.chat, { image: { url: api('lolhuman', '/textpro/' + command, { text: text }, 'apikey') }, caption: `Text Pro ${command}` }, { quoted: m})
	    }
            break
	    case 'shadow': case 'romantic': case 'smoke': case 'burnpapper': case 'naruto': case 'lovemsg': case 'grassmsg': case 'lovetext': case 'coffecup': case 'butterfly': case 'harrypotter': case 'retrolol': {
                if (!text) throw 'No Query Text'
                m.reply(mess.wait)
                hisoka.sendMessage(m.chat, { image: { url: api('lolhuman', '/photooxy/' + command, { text: text }, 'apikey') }, caption: `Photo Oxy ${command}` }, { quoted: m })
            }
            break
            case 'ffcover': case 'crossfire': case 'galaxy': case 'glass': case 'neon': case 'beach': case 'blackpink': case 'igcertificate': case 'ytcertificate': {
                if (!text) throw 'No Query Text'
                m.reply(mess.wait)
                hisoka.sendMessage(m.chat, { image: { url: api('lolhuman', '/ephoto/' + command, { text: text }, 'apikey') }, caption: `Ephoto ${command}` }, { quoted: m })
            }
            break
	    case 'nomerhoki': case 'nomorhoki': {
	        ...
	        case 'tiktok': case 'tiktoknowm': {
                ...
                m.reply(mess.wait)
                let anu = await fetchJson(api('lolhuman', '/downloader/tiktok', { url: text }, 'apikey'))
                let buttons = [
		...
		let cnvrt = await toAudio(nganu, 'mp4')
	        ...
	        case 'instagram': case 'ig': case 'igdl': {
                ...
                if (/(?:\/p\/|\/reel\/|\/tv\/)([^\s&]+)/.test(isUrl(text)[0])) {
                    let anu = await fetchJson(api('lolhuman', '/downloader/instagram2', { url: isUrl(text)[0] }, 'apikey'))
                    for (let media of anu.data) hisoka.sendMedia(m.chat, media, '', `Download Url Instagram From ${isUrl(text)[0]}`, m)
                } else if (/\/stories\/([^\s&]+)/.test(isUrl(text)[0])) {
                    let anu = await fetchJson(api('lolhuman', '/downloader/instastory', { url: isUrl(text)[0] }, 'apikey'))
            ...
            case 'joox': case 'jooxdl': {
                ...
                m.reply(mess.wait)
                let anu = await fetchJson(api('lolhuman', '/downloader/joox', { query: text }, 'apikey'))
            ...
            case 'soundcloud': case 'scdl': {
                if (!text) throw 'No Query Title'
                m.reply(mess.wait)
                let anu = await fetchJson(api('lolhuman', '/downloader/soundcloud', { url: isUrl(text)[0] }, 'apikey'))
	        ...
	        case 'twitdl': case 'twitter': {
                if (!text) throw 'Masukkan Query Link!'
                m.reply(mess.wait)
                let anu = await fetchJson(api('lolhuman', '/api/downloader/twitter', { url: text }, 'apikey'))
                let buttons = [
	        ...
	        case 'fbdl': case 'fb': case 'facebook': {
                if (!text) throw 'Masukkan Query Link!'
                m.reply(mess.wait)
                let anu = await fetchJson(api('lolhuman', '/api/downloader/facebook', { url: text }, 'apikey'))
	        ...
	        case 'pindl': case 'pinterestdl': {
                if (!text) throw 'Masukkan Query Link!'
                m.reply(mess.wait)
                let anu = await fetchJson(api('lolhuman', '/api/downloader/pinterestdl', { url: text }, 'apikey'))
		...
		break
		   case 'bass': case 'blown': case 'deep': case 'earrape': case 'fast': case 'fat': case 'nightcore': case 'reverse': case 'robot': case 'slow': case 'smooth': case 'tupai':
            ...
            case 'setcmd': {
                ...
                if (!m.quoted.fileSha256) throw 'YAN Hash Missing'
...
• _${prefix}motivasi_
• _${prefix}dilanquote_
• _${prefix}bucinquote_
• _${prefix}katasenja_
• _${prefix}puisi_
• _${prefix}couple_
• _${prefix}anime_
...
*Text Pro Menu*
• _${prefix}3dchristmas_
• _${prefix}3ddeepsea_
• _${prefix}americanflag_
• _${prefix}3dscifi_
• _${prefix}3drainbow_
• _${prefix}3dwaterpipe_
• _${prefix}halloweenskeleton_
• _${prefix}sketch_
• _${prefix}bluecircuit_
• _${prefix}space_
• _${prefix}metallic_
• _${prefix}fiction_
• _${prefix}greenhorror_
• _${prefix}transformer_
• _${prefix}berry_
• _${prefix}thunder_
• _${prefix}magma_
• _${prefix}3dcrackedstone_
• _${prefix}3dneonlight_
• _${prefix}impressiveglitch_
• _${prefix}naturalleaves_
• _${prefix}fireworksparkle_
• _${prefix}matrix_
• _${prefix}dropwater_
• _${prefix}harrypotter_
• _${prefix}foggywindow_
• _${prefix}neondevils_
• _${prefix}christmasholiday_
• _${prefix}3dgradient_
• _${prefix}blackpink_
• _${prefix}gluetext_
...
• _${prefix}beach_
• _${prefix}blackpink_
• _${prefix}igcertificate_
• _${prefix}ytcertificate_
...
• _${prefix}artimimpi_
• _${prefix}artinama_
• _${prefix}ramaljodoh_
• _${prefix}ramaljodohbali_
• _${prefix}suamiistri_
• _${prefix}ramalcinta_
• _${prefix}cocoknama_
• _${prefix}pasangan_
• _${prefix}jadiannikah_
• _${prefix}sifatusaha_
• _${prefix}rezeki_
• _${prefix}pekerjaan_
• _${prefix}nasib_
• _${prefix}penyakit_
...
• _${prefix}fengshui_
• _${prefix}haribaik_
• _${prefix}harisangar_
• _${prefix}harisial_
• _${prefix}nagahari_
• _${prefix}arahrezeki_
• _${prefix}peruntungan_
• _${prefix}weton_
• _${prefix}karakter_
• _${prefix}keberuntungan_
• _${prefix}memancing_
• _${prefix}masasubur_
• _${prefix}zodiak_
• _${prefix}shio_
...
• _${prefix}ping_
• _${prefix}owner_
• _${prefix}menu / ${prefix}help / ${prefix}?_
• _${prefix}delete_
• _${prefix}infochat_
• _${prefix}quoted_
• _${prefix}listpc_
...
◎ Base : *DikaArdnt*
◎ Penyusun : *Haikal*
◎ Lib : (YanXd) Baileys - Multi-Device
◎ Terbit : *30-03-2022*
...
• Dana : -
• Pulsa : 0895323413434
• Qriss All : Minta ke owner

*Note* : Bot On 24 Jam, Karena Run Di Heroku
Mau Sewa Bot? : Chat Ownernya
( *https://wa.me/62895323413434* )

`
    let message = await prepareWAMessageMedia({ image: fs.readFileSync('./poto/sewabot.jpg') }, { upload: hisoka.waUploadToServer })
                const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
                            imageMessage: message.imageMessage,
...
`
    let message = await prepareWAMessageMedia({ image: fs.readFileSync('./poto/sewa.jpg') }, { upload: hisoka.waUploadToServer })
                const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
                            imageMessage: message.imageMessage,
                            ...
                            hydratedButtons: [{
                                ...
                                callButton: {
                                    displayText: 'Number Phone Owner',
                                    phoneNumber: 'wa.me/63895323413434'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: 'Status Bot',
